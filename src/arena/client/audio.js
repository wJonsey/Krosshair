...
const SHOTS = {
  ...
  vesper: { thump: [110, 44, 0.32, 0.9], crack: [2800, 0.08, 0.85], body: [1100, 0.42, 0.8], ref: 13, send: 0.55 },
  harbinger: { thump: [62, 26, 0.6, 1.2], crack: [2000, 0.13, 1], body: [520, 0.8, 1.1], ref: 18, send: 0.75 },
  ronin: { thump: [115, 48, 0.17, 0.8], crack: [2700, 0.055, 0.8], body: [1200, 0.22, 0.7], ref: 11, send: 0.4 },
  halcyon: { thump: [155, 70, 0.1, 0.55], crack: [3400, 0.04, 0.65], body: [1700, 0.14, 0.55], ref: 9, send: 0.3 },
  anvil: { thump: [100, 42, 0.16, 0.8], crack: [2600, 0.05, 0.75], body: [1100, 0.2, 0.7], ref: 12, send: 0.4 },
  hornet: { thump: [190, 90, 0.06, 0.45], crack: [3700, 0.03, 0.55], body: [2100, 0.09, 0.45], ref: 7, send: 0.2 },
  maul: { thump: [90, 38, 0.28, 0.9], crack: [1900, 0.08, 0.85], body: [720, 0.38, 0.9], ref: 11, send: 0.5 },
  pike: { thump: [200, 90, 0.07, 0.5], crack: [3500, 0.035, 0.6], body: [1900, 0.1, 0.5], ref: 7, send: 0.22 },
  wren: { thump: [260, 120, 0.05, 0.25], crack: [1400, 0.05, 0.18], body: [900, 0.08, 0.3], ref: 3, send: 0.05 },
  sawn: { thump: [70, 30, 0.42, 1.1], crack: [1700, 0.12, 0.95], body: [600, 0.55, 1.05], ref: 12, send: 0.6 },
};
