...
export const DEFAULT_SETTINGS = {
  sensitivity: 1, scopeSensitivity: 0.7, fov: 78, volume: 0.8, ambience: 0.6, music: 0.9, musicInMatch: true, announcer: true, invertY: false, padSensitivity: 1, aimAssist: true, toggleScope: false, toggleCrouch: false, visualizeSound: true,
