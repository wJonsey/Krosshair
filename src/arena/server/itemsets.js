...
export const ALL_SETS = [
  ...
  { id: 'neonwake', name: 'Neon Wake', blurb: 'Rain, and everything reflected in it.', debut: '2027-02-15',
    items: [['finish', 'neonwake'], ['finish', 'wetstreet'], ['visor', '#2ad1ff'], ['tracer', '#2ad1ff']] },
  { id: 'saltmarsh', name: 'Saltmarsh', blurb: 'Tide came in and took the paint with it.', debut: '2027-03-01',
    items: [['finish', 'saltmarsh'], ['finish', 'brackish'], ['pattern', 'reedbed']] },
  { id: 'ironworks', name: 'Ironworks', blurb: 'Cut, welded, never finished properly.', debut: '2027-03-15',
    items: [['finish', 'ironworks'], ['finish', 'millscale'], ['headgear', 'weldmask'], ['charm', 'boltring']] },
  { id: 'bloom', name: 'Bloom', blurb: 'Somebody painted flowers on a rifle.', debut: '2027-03-29',
    items: [['finish', 'bloom'], ['finish', 'nightgarden'], ['pattern', 'petals']] },
  { id: 'coldsnap', name: 'Cold Snap', blurb: 'Frozen through, then frozen again.', debut: '2027-04-12',
    items: [['finish', 'coldsnap'], ['finish', 'blackice'], ['face', 'frostmask'], ['tracer', '#bfe9ff']] },
  { id: 'hex', name: 'Hex', blurb: 'Old marks that still mean something.', debut: '2027-04-26',
    items: [['finish', 'hex'], ['finish', 'sigil'], ['pack', 'grimoire'], ['charm', 'talisman']] },
  { id: 'roadwork', name: 'Roadwork', blurb: 'Hard to miss. That is the idea.', debut: '2027-05-10',
    items: [['finish', 'roadwork'], ['finish', 'chevron'], ['headgear', 'hivis']] },
  { id: 'apparition', name: 'Apparition', blurb: 'Half there on a good day.', debut: '2027-05-24',
    items: [['finish', 'apparition'], ['finish', 'seance'], ['face', 'shroud'], ['tracer', '#d8ccff']] },
  { id: 'sunfall', name: 'Sunfall', blurb: 'The last twenty minutes of the day.', debut: '2027-06-07',
    items: [['finish', 'sunfall'], ['finish', 'emberline'], ['pattern', 'duskfade']] },
  // Not out yet. These stay hidden from every list until the day they land.
  { id: 'vault', name: 'Vault', blurb: 'Spend it on something loud.', debut: '2027-06-21',
    items: [['finish', 'vault'], ['finish', 'bullion'], ['charm', 'keyring'], ['title', 'Loaded']] },
  { id: 'static', name: 'Static', blurb: 'Signal lost. Kept firing.', debut: '2027-07-05',
    items: [['finish', 'static'], ['finish', 'lostsignal'], ['visor', '#8affc9'], ['pack', 'jammer']] },
  { id: 'lowtide', name: 'Low Tide', blurb: 'Dragged up off the sea floor.', debut: '2027-07-19',
    items: [['finish', 'lowtide'], ['finish', 'barnacle'], ['face', 'rebreather']] },
  { id: 'redline', name: 'Redline', blurb: 'Built to go one way, fast.', debut: '2026-12-21',
    items: [['finish', 'polestart'], ['finish', 'gridstart'], ['headgear', 'racehelm'], ['tracer', '#ff5a3d']] },
  { id: 'quarry', name: 'Quarry', blurb: 'Cut out of a hillside and barely finished.', debut: '2026-12-28',
    items: [['finish', 'quarry'], ['finish', 'limestone'], ['finish', 'slatefall'], ['finish', 'dustveil']] },
  { id: 'tempest', name: 'Tempest', blurb: 'Weather that came in off the sea.', debut: '2027-01-04',
    items: [['finish', 'tempest'], ['finish', 'squall'], ['finish', 'thunderhead'], ['finish', 'downpour']] },
  { id: 'crucible', name: 'Crucible', blurb: 'Poured, cooled, never cleaned up.', debut: '2027-01-11',
    items: [['finish', 'crucible'], ['finish', 'slagline'], ['finish', 'whitehot'], ['finish', 'quench']] },
  { id: 'overgrowth', name: 'Overgrowth', blurb: 'Left alone long enough for the green to win.', debut: '2027-01-18',
    items: [['finish', 'overgrowth'], ['finish', 'creeper'], ['finish', 'mossback'], ['finish', 'thornline']] },
  { id: 'signal', name: 'Signal', blurb: 'Lights meant to be seen from a long way off.', debut: '2027-01-25',
