...
- **Shop** (menu tab 03), seven tabs:
  - **Crates** (opens first): Field 120, Camo 90, Elite 450, Neon 650, each with its own drop pool and odds on the page. A free field crate every 20 hours, open one or five at a time, Field and Elite guarantee an Epic or better within 10 opens. Legendary and Mythic drops are announced to everyone online.
  - **Skins**: 44 gun finishes. Buying one outright is deliberately steep (Common 1,500, Rare 4,000, Epic 10,000, Legendary 25,000) so crates are the better deal; Mythics can't be bought at all. Only Mythics animate, and every Mythic does: each is its own shader (gold shine sweep, parallax starfield, magma cracks, shifting dragon scales, hex light waves, aurora ribbons, live fire, glitching hologram, thin-film prism, pulsing neon grid, flowing circuits, oozing toxic, frost glints). Every finish is shown on a live 3D turntable.
  - **Gear**: every operator item (headgear, face, pack, pattern, suit/visor/tracer colours, titles) with a 3D try-on before you buy.
  - **Charms**: gun charms swinging on the gun of your choice.
  - **Inventory**: every skin you own; scrap one for 40% of its value, or trade up five of one rarity for a random skin of the next.
  - **Games**: Crash (cash out before it crashes; the server settles it even if you leave), Plinko, Higher or lower, coin flip, dice and slots, each keeping about 5%, with your last 20 bets.
  - **Wallet**: balance, today and 7-day totals, a 14-day chart, where coins came from and went, a friends list (online status, one-click send) and **sending coins** to any pilot by username (their name and Discord picture shown before you confirm).
  Scrap and duplicate refunds use a skin's value (Common 40 up to Mythic 5,000), kept low enough that opening crates to scrap them always loses coins.
